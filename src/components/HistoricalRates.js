        ...
        return(
            <div className='historical-rates'>
                <div className='hr-info'>
                    ...
                    <p>A trip costing 10,000 {this.props.destination.currency_name} would cost ${(10000 / this.state.startRate).toFixed(2)} United States Dollars if the currency were exchanged at the time this trip was entered to the site. The same trip would cost ${(10000 / this.state.currentRate).toFixed(2)} if the currency were exchanged now.</p>
                </div>
            </div>
        )
    }
